...
#V3 20/07/2021 Enhances by Stephen Bell
...
#$VerbosePreference =
$Filename = "C:\Users\StephenBell_mw03ceg\TShopBiz & Entag Group\Projects - Customer Projects\THE BMD GROUP\TCO Project Docs\Customer Facing_Link_Shared\Migration Sheets\User_License_Upload20210723.csv"
...
write-host "Start Time: " -NoNewline -foregroundcolor Yellow
write-host "$StartDate" -ForegroundColor Cyanwrite-host "Finish Time: " -NoNewline -foregroundcolor Yellow

...
This script generated for Waikato and Bay of Plenty, New Zealand.
...
Run the program from Microsoft Teams Powershell by typing .\NZ-07-MSTeams.ps1. 
#>
...
If ($DialPlanSelect -eq 1) {
	...
	$DPParent = "NZ-09"
	New-CsTenantDialPlan $DPParent -Description "Normalization rules for Waikato and Bay of Plenty, New Zealand"
}

...
$VmailDisplay = "Q3Crestmead Voicemail"
$VmailName = "Q3Crestmead-Voicemail"
$CQ1Name = "CQ-Q3Crestmead-Sales"
$aaName = "AA-Q3Crestmead"
$CQStateid = (Get-CsCallQueue -Namefilter "CQ-QLD-Sales").identity
$CQStateappinstanceid =(Get-CsOnlineUser "CQ-QLD-Sales@oxworks.onmicrosoft.com").objectId
$Holidayname = "QLD Public Holidays 2021"
...
Connect-msolservice
$SGgroupid =(Get-msolgroup -SearchString "SG-Q3Crestmead").objectId

...
$VmailDisplay = "BibraLake Voicemail"
$VmailName = "BibraLake-Voicemail"
$CQ1Name = "CQ-BibraLake-Sales"
$aaName = "AA-BibraLake"
$CQStateid = (Get-CsCallQueue -Namefilter "CQ-WA-Sales").identity
$CQStateappinstanceid =(Get-CsOnlineUser "CQ-WA-Sales@oxworks.onmicrosoft.com").objectId
$Holidayname = "WA Public Holidays 2021"
...
Connect-msolservice
$SGgroupid =(Get-msolgroup -SearchString "SG-Bibralake").objectId

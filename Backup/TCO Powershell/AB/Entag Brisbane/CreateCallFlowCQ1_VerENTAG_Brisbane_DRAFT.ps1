...
$greetingcontent = Get-Content "C:\Users\AndrewBaird\TShopBiz & Entag Group\ENTAG Connect - Documents\Customers\ENTAG Group\TCO\Entag Office move\Brisbane\OneDrive_1_12-08-2021_Refined\Mobility-Welcome-QAS.wav" -Encoding byte -ReadCount 0
$greetingaudioFile = Import-CsOnlineAudioFile -ApplicationId "OrgAutoAttendant" -FileName "Mobility-Welcome-QAS.wav" -Content $greetingcontent
...
$VmailDisplay = "QAS-Voicemail"
$VmailName = "QAS-Voicemail"
...
$holdmenu = New-CsAutoAttendantMenu -Name "AA-QASHoldmenu" -Prompts @($holdgreetingprompt) -EnableDialByName -MenuOptions @($holdmenuOption1,$holdmenuOption2)

############################################
#Script to Create basic call flow-Caloundra-Art Gallery #
...
$greetingText = "Welcome to Caloundra Regional Art Gallery.Please hold the line while we connect you with one of the team."
$afterHoursText = "Thank you for calling  Caloundra Regional Art Gallery. You have reached us outside of our normal office hours. Please hold to leave a voicemail with your name and contact number, and one of our friendly staff will return your call."
...
$holidaygreetingtext = "Thank you for calling  Caloundra Regional Art Gallery. You have reached us outside of our normal office hours. Please hold to leave a voicemail with your name and contact number, and one of our friendly staff will return your call."
#----
$Sitename = "CAL-Art-Gallery"
...
#----
$aaName = "AA-"+$sitename
$tr1 = New-CsOnlineTimeRange -Start 10:00 -End 16:00
...
# After hours
$afterHoursSchedule = New-CsOnlineSchedule -Name "Business Hours" -WeeklyRecurrentSchedule -TuesdayHours @($tr1) -WednesdayHours @($tr1) -ThursdayHours @($tr1) -FridayHours @($tr1) -SaturdayHours @($tr2) -SundayHours @($tr2) -Complement

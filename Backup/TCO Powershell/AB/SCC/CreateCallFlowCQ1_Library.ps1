############################################
#Script to Create basic call flow-Caloundra-Library #
...
$greetingText = "Welcome to Caloundra Library. Please hold the line while we connect you with one of the team."
...
# Call Queue 1 Stage
$AAredirect = Get-CsOnlineApplicationInstance -SearchQuery "AA-LibraryRedirect"
#Create Call Queue
New-CsCallQueue -Name $CQ1Name -RoutingMethod $routingmethod -AllowOptOut $true -AgentAlertTime $AgentalertCQ1 -LanguageId $language -UseDefaultMusicOnHold $true -ConferenceMode $true -TimeoutThreshold $AgentalertCQ1 -TimeoutAction Forward -TimeoutActionTarget $AAredirect

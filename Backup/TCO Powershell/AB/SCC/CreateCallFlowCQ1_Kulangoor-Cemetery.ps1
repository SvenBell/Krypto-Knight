############################################
#Script to Create basic call flow-Kulangoor-Cemetery #
...
$greetingText = "Welcome to Cemetery Services. Please hold the line while we connect you with one of the team."
$afterHoursText = "Thank you for calling, our office hours are 8:30 to 4:30 Monday to Friday excluding public holidays please leave a message and we will get back to you"
...
$holidaygreetingtext = "Thank you for calling, our office hours are 8:30 to 4:30 Monday to Friday excluding public holidays please leave a message and we will get back to you"
#----
$Sitename = "Kulangoor-Cemetery"
$vmname = "Cemetery-Services"
$VmailDisplay = "VM-"+$vmname
$VmailName = "VM-"+$vmname

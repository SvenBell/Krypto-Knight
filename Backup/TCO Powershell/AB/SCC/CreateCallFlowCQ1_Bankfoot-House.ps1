...
$greetingText = "Welcome to Bankfoot house. Please hold the line while we connect you with one of the team."
$afterHoursText = "Thank you for calling Bankfoot house. You have reached us outside of our normal office hours. Please hold to leave a voicemail with your name and contact number, and one of our friendly staff will return your call."
...
$holidaygreetingtext = "Thank you for calling Bankfoot house. You have reached us outside of our normal office hours. Please hold to leave a voicemail with your name and contact number, and one of our friendly staff will return your call."
#----
$VmailDisplay = "VM-Bankfoot-House"
$VmailName = "VM-Bankfoot-House"

#----
$CQ1Name = "CQ-Bankfoot-House"

#----
$aaName = "AA-Bankfoot-House"
$tr1 = New-CsOnlineTimeRange -Start 08:00 -End 17:00
$tr2 = New-CsOnlineTimeRange -Start 09:30 -End 15:30
...
# After hours
$afterHoursSchedule = New-CsOnlineSchedule -Name "Business Hours" -WeeklyRecurrentSchedule -MondayHours @($tr1) -TuesdayHours @($tr1) -WednesdayHours @($tr1) -ThursdayHours @($tr1) -FridayHours @($tr1) -SaturdayHours @($tr2) -SundayHours @($tr2) -Complement

############################################
#Script to Create basic call flow-NambourShowgrounds #
...
$greetingText = "Welcome to Nambour ShowGrounds. Please hold the line while we connect you with one of the team."
$afterHoursText = "Thank you for calling, our office hours are 7:00 to 5:00 Monday to Friday excluding public holidays please leave a message and we will get back to you"
...
$holidaygreetingtext = "Thank you for calling, our office hours are 7:00 to 5:00 Monday to Friday excluding public holidays please leave a message and we will get back to you"
#----
$Sitename = "NambourShowgrounds"

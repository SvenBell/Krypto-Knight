...
Write-host ""
$Filename = "C:\Users\StephenBell_mw03ceg\TShopBiz & Entag Group\Projects - Customer Projects\Campbell Construction\PR2839-UCBlockHoursSupport\PROJECT HANDOVER SUMMARY\BulkAACQ.csv"
...
foreach ($user in $users) {
	...
	# If the is a Display Name on .csv live Create Call Queue
	if ($CQDisplayName -ne "") {
		#$LastCQUPN = $CQUPN

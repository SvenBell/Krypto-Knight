...
# Uncomment one of the following to use function:
# Example: Get-CsPhoneNumberAssignment -LineUri 617 | Export-Csv "c:\Backup\SRRC-SfB-NumberAssignments.csv" -NoTypeInformation
# Example: Get-CsPhoneNumberAssignment | Export-Csv "c:\Backup\SRRC-SfB-NumberAssignments.csv" -NoTypeInformation
# Example: Get-CsPhoneNumberAssignment 
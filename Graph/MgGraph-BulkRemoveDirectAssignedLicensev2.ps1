<#
  V2. Enhanced by Stephen to add extra comments, confirmation prompt, license sku list, and lastly, UserPricipalName in report
...
Write-Host "Direct Assign License SKU to remove: " $skuId
read-host “Checking AD Group: " $LicensedGroup "  , press Enter to continue or Ctrl-C to exit”

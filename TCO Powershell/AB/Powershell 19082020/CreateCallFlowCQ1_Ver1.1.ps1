...
$VmailDisplay = "Reception Voicemail6"
$VmailName = "Reception-Vmail6"
...
# Call Queue 1 Stage
$CQ1Name = "CQ-Reception6"
#Create Call Queue
New-CsCallQueue -Name $CQ1Name -RoutingMethod Attendant -AllowOptOut $true -AgentAlertTime $AgentalertCQ1 -UseDefaultMusicOnHold $true -TimeoutThreshold $AgentalertCQ1 -TimeoutAction Forward -TimeoutActionTarget $aaappinstanceidAAQ 

...
#Matches Script_Call_Flow_DiagramCQ2.vsdx#
#Date: 22/03/2020                          #
...
$greetingText = "Welcome to Adams Sparkes Town Planning. Please hold the line while we connect you with one of the team."
$afterHoursText = "Thank you for calling Adams Sparkes Town Planning. You have reached us outside of our normal office hours. Please hold to leave a voicemail with your, name and contact number, and one of our friendly staff will return your call."
...
Start-Sleep -s 300
$CQ3appinstanceid = (Get-CsOnlineUser $CQ3Name@$domain).ObjectId
...
# Call Queue 2 Stage
$CQ2Name = "CQ-Overflow-1"
#Create Call Queue
New-CsCallQueue -Name $CQ2Name -RoutingMethod Attendant -AllowOptOut $true -AgentAlertTime $AgentalertCQ2 -UseDefaultMusicOnHold $true -TimeoutThreshold $AgentalertCQ2 -TimeoutAction Forward -TimeoutActionTarget $CQ3appinstanceid 
#Create Call Queue Resource Account
...
$aaName = "AA-Main"
$tr1 = New-CsOnlineTimeRange -Start 08:30 -End 17:00
# After hours

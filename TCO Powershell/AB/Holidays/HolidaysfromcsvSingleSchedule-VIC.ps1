...
$schedule = New-CsOnlineSchedule -name "VIC Public Holidays 2021" -Fixedschedule -DateTimeRanges $newyears


$Filename = "C:\GitHub\PowerShell\TCO Powershell\AB\Holidays\Holidays2021-VIC-formatted.csv"

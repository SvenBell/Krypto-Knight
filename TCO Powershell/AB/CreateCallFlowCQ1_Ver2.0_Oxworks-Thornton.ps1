...
$VmailDisplay = "Glendenning Voicemail"
$VmailName = "Glendenning-Voicemail"
$CQ1Name = "CQ-Glendenning-Sales"
$CQStateid = (Get-CsCallQueue -Namefilter "CQ-NSW-Sales").identity
$CQStateappinstanceid =(Get-CsOnlineUser "CQ-NSW-Sales@M365x064666.onmicrosoft.com").objectId
$aaName = "AA-Glendenning"
...
$holidayscallflow = New-CsAutoAttendantCallFlow -Name "Holidays" -Menu $holidaysMenu -Greetings @($holidaysGreetingPrompt)

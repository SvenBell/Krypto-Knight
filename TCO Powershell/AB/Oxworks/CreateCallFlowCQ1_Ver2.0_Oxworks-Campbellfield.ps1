...
#BSW/VIC                    : AUS Eastern Standard Time
...
$VmailDisplay = "Campbellfield Voicemail"
$VmailName = "Campbellfield-Voicemail"
$CQ1Name = "CQ-Campbellfield-Sales"
$aaName = "AA-Campbellfield"
...
$Holidayname = "VIC Public Holidays"
...
# Call Queue 1 Stage
#Create Call Queue
New-CsCallQueue -Name $CQ1Name -RoutingMethod Attendant -AllowOptOut $true -AgentAlertTime $AgentalertCQ1 -UseDefaultMusicOnHold $true -OverflowThreshold 50 -TimeoutThreshold $AgentalertCQ1 -ConferenceMode $true -LanguageId $language -OverflowAction Forward -OverflowActionTarget $CQStateappinstanceid -TimeoutAction Forward -TimeoutActionTarget $CQStateappinstanceid

...
$SMTPPort = "587"
$username = "test3@bairditsolutions.com"
$pwd = “TEngine88!”
...
$movieLocation = "C:\temp\randomdata\MOV"
#Location of MP3 music attachments
$audioLocation = "C:\temp\randomdata\MP3"
#Location of JPG picture attachments
$imageLocation = "C:\temp\randomdata\JPG"
#Location of text document that holds words, an ebook in this case
$textLocation = "C:\temp\randomdata\ebook.txt"

#Address details
$toAddress = "test2@bairditsolutions.com"
$fromAddress = "test3@bairditsolutions.com"
...
Send-MailMessage -To $toAddress -From $fromAddress -Subject $selectedSubject -Body $selectedText -SmtpServer $smtpServer -port $SMTPPort -UseSsl -Credential $credentials -Verbose
} else {
#Send email WITH attachment
Send-MailMessage -To $toAddress -From $fromAddress -Subject $selectedSubject -Body $selectedText -SmtpServer $smtpServer -port $SMTPPort -UseSsl -Credential $credentials -Attachments $selectedAttachment -Verbose
$selectedAttachment
}

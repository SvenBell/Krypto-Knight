############################################
#Script to Create basic call flow-Maroochy-on-First #
...
$greetingText = "Thank you for calling Sunshine Coast Council’s Development Services Team. Please hold the line while we connect you with one of the team."
$afterHoursText = "Thank you for calling Sunshine Coast Council's Development Services. Our office hours are 8.15 to 5pm Monday to Friday, excluding public holidays. Please leave a message and we will get back to you as soon as we can."
...
$holidaygreetingtext = "Thank you for calling Sunshine Coast Council's Development Services. Our office hours are 8.15 to 5pm Monday to Friday, excluding public holidays. Please leave a message and we will get back to you as soon as we can."
#----
$Sitename = "DevelopmentServices"
...
$aaName = "AA-"+$sitename
$tr1 = $null
$tr1 = New-CsOnlineTimeRange -Start 08:15 -End 17:00
$tr2 = $null

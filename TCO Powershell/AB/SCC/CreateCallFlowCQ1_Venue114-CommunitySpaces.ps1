############################################
#Script to Create basic call flow-SCCVenue114-Community Spaces #
...
$greetingText = "Welcome to Sunshine Coast’s Community Spaces. Please hold the line while we connect you with one of the team."
$afterHoursText = "Thank you for calling Sunshine Coast’s Community Spaces. You have reached us outside of our normal office hours. Please hold to leave a voicemail with your name and contact number, and one of our friendly staff will return your call. Alternatively, check out our website www.venue114.com.au for more information."
$greetingTextAAQ = "Thank you for calling Sunshine Coast’s Community Spaces. Unfortunately, we are unable to take your call at the moment.  Please hold to leave a message with your name, phone number and a short message, and we'll return your call. Alternatively, check out our website www.venue114.com.au for more information. Thank you. "
$holidaygreetingtext = "Thank you for calling Sunshine Coast’s Community Spaces. You have reached us outside of our normal office hours. Please hold to leave a voicemail with your name and contact number, and one of our friendly staff will return your call. Alternatively, check out our website www.venue114.com.au for more information."
#----
$VmailDisplay = "VM-CommunitySpaces"
$VmailName = "VM-CommunitySpaces"

#----
$CQ1Name = "CQ-CommunitySpaces"

#----
$aaName = "AA-CommunitySpaces"
$tr1 = New-CsOnlineTimeRange -Start 08:30 -End 16:30

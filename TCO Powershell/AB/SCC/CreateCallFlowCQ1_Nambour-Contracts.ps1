############################################
#Script to Create basic call flow-Nambour-Contracts #
...
$greetingText = "Welcome to Sunshine Coast Council’s Contract and Supply Services. Please hold the line while we connect you with one of the team."
$afterHoursText = "Thank you for calling Sunshine Coast Council’s Contract and Supply Services.You have reached us outside of our normal office hours. Please hold to leave a voicemail with your, name and contact number, and one of our friendly staff will return your call."
...
$holidaygreetingtext = "Thank you for calling Sunshine Coast Council’s Contract and Supply Services. You have reached us outside of our normal office hours. Please hold to leave a voicemail with your, name and contact number, and one of our friendly staff will return your call."
#----
$Sitename = "Contracts"
...
$aaName = "AA-"+$sitename
$tr1 = $null
$tr1 = New-CsOnlineTimeRange -Start 07:30 -End 17:00
$tr2 = $null
...
#Create Call Queue
New-CsCallQueue -Name $CQ1Name -RoutingMethod $routingmethod -AllowOptOut $true -AgentAlertTime $AgentalertCQ1 -LanguageId $language -EnableTimeoutSharedVoicemailTranscription $true -UseDefaultMusicOnHold $true -ConferenceMode $true -TimeoutThreshold $TimeoutCQ1 -timeoutsharedvoicemailtexttospeechprompt $greetingTextAAQ -TimeoutAction SharedVoicemail -TimeoutActionTarget $VmailcallableEntityGroup

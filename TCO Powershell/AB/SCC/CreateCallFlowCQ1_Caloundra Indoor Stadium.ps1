...
#$holidaygreetingtext = "Thank you for calling River CIty Solutions. You have reached us outside of our normal office hours. Please hold to leave a voicemail with your, name and contact number, and one of our friendly staff will return your call."
...
#Create Call Queue
New-CsCallQueue -Name $CQ1Name -RoutingMethod Attendant -AllowOptOut $true -AgentAlertTime $AgentalertCQ1 -UseDefaultMusicOnHold $true -TimeoutThreshold $AgentalertCQ1 -timeoutsharedvoicemailtexttospeechprompt $greetingTextAAQ -TimeoutAction SharedVoicemail -TimeoutActionTarget $VmailcallableEntity

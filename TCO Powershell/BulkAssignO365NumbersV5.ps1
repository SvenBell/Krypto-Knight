...
#$VerbosePreference =
$Filename = "C:\Users\StephenBell\Entag Group\Projects - Customer Projects\YOURTOWN\PR2864-MicrosoftOperatorConnect\LD26916 - MSOC\Project Docs\Call Flow Diagrams & Detailing Sheets\NumberAssignments.csv"
...
ForEach ($user in $users) {
    ...
    Try {
        ...
        $loc=Get-CsOnlineLisLocation -City $Location
